        ...
        <div class=" hidden sm:block">
            <BreadCrumb>
                <template v-slot:first>
                    <BreadCrumbCell url="about">A propos</BreadCrumbCell>
                </template>
                <template v-slot:second>
                    <BreadCrumbCell url="skills">Compétences</BreadCrumbCell>
                </template>
              <template v-slot:third>
                <BreadCrumbCell url="experiences">Experiences</BreadCrumbCell>
              </template>
                <template v-slot:fourth>
                    <BreadCrumbCell url="projects">Projets</BreadCrumbCell>
                </template>
            </BreadCrumb>
        </div>
    </header>
